    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'global_messages.msg.Controller')
            logger.debug(
...
class Controller(metaclass=Metaclass_Controller):
    ...
    def __init__(self, **kwargs):
        ...
        self.angvel = kwargs.get('angvel', float())
    ...
    def angvel(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'angvel' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'angvel' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._angvel = value
